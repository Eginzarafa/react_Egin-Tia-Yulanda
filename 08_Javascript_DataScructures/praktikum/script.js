...
function searchProduct() {
    ...
    for (i = 1; i < tr.length; i++) { // Mulai dari 1 untuk melewati baris header tabel
        td = tr[i].getElementsByTagName("td")[1]; // Ganti 1 dengan indeks kolom yang ingin Anda cari
        if (td) {

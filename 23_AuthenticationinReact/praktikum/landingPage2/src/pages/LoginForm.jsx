...
const LoginForm = () => {
  ...
  const [showSuccessPopup, setShowSuccessPopup] = useState(false); // State untuk menampilkan popup berhasil
  ...
  const onSubmit = (values) => {
    const validEmail = "eginyulanda@gmail.com";
    const validPassword = "12345678";

    if (values.email === validEmail && values.password === validPassword) {
      setShowSuccessPopup(true); // Tampilkan popup login berhasil
      setTimeout(() => {
        navigate("/createproduct");
      }, 2000); // Arahkan ke halaman setelah 2 detik
    } else {
            ...
            <Form className="mt-8 space-y-6">
              ...
              {showSuccessPopup && (
                <div className="text-center text-green-600">
                  Login berhasil! Anda akan dialihkan dalam 2 detik...
                </div>
              )}
